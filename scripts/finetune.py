...
from plame.data.msadata import MSADataSet, MSABatchConverter, Alphabet, MSADataSet_, MSADataSet_v2, MSADataSet_v3
...
class GradientClippingTrainer(Trainer):
    ...
    def compute_loss(self, model, inputs, return_outputs=False):
        ...
        # Primary loss from the model
        loss = outputs.loss
        
        # Recompute auxiliary losses for logging
